...
<details>
  ...
  | ---                            | ---                                                        | ---                                    | ---              |
  | hamburger menu goed krijgen     witruimte aan de randen van de pagina weghalen
                                   |topverhalen sectie goed krijgen                             |flexbox, justify content toepassen      | niet aanwezig    |
  |meer uitleg over css map met ::roots 
   
  |                                |hamburgermenu icoon kleiner maken, kruisje op dezelfde plek |werken met background img               |                  |
  |                                | ...                                                        | ...                                    | ...              |
